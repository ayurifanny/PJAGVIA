    ...
    <div class="row justify-content-center">
        <div class="col-md-10 py-3">
            @if(auth()->user()->hasRole('customer'))
                <div class="card mt-4">
                    <div class="card-header">
                        <p class="h3 p-1"><strong>Inspection Request</strong></p>
                    </div>
                    <div class="card-body">
            ...
            <div class="card mt-4 pb-3">
                <div class="card-header">
                    <p class="h3 p-1"><strong>Inspection History</strong></p>
                </div>
                <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($meeting_history as $key => $meeting)
                                    <tr>
                                        <td>{{ ++$key }}</td>
                                        <td><a href='/meetings/detail/{{ $meeting->id }}'>{{ $meeting->project_name }}
                                            </a></td>
                                        @if(auth()->user()->hasRole('inspector'))
