...
<div class="container">
    ...
    <div class="row menu-canvas mx-1 my-2 py-3">
        <div class="col-md px-0">
            <h4 class="align-center"><strong>Galvanizing Inspection Report</strong></h4>
        </div>
    ...
    <div class="row">
        ...
        <div class="col ">:
            <span class="ml-2">{{ $meeting_data[0]->quantity }} Kg / {{ round($meeting_data[0]->quantity / 1000, 4) }} Ton</span>
        </div>
    </div>
    <br>
    <div>
