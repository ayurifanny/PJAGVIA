...
<div class="container">
    <div class="row menu-canvas my-2 py-3">
    ...
    <div class="row pt-2">
        <div class="col-sm-2 pl-0">Project Name</div>
        <div class="col ">: 
    ...
    <div class="row">
        <div class="col-sm-2 pl-0">Inspection Date</div>
        <div class="col ">: 
    ...
    <br>
    <div>
        <div class="row pl-0"><strong>APPROVED MATERIAL</strong></div>  
        <div class="row pl-0">
    ...
    <br>
    <div>
        <div class="row pl-0"><strong>DECLINED MATERIAL</strong></div>  
        <div class="row pl-0">    
                    ...
                    @foreach($upload_data_declined as $key => $picd)
                        <tr>
                            ...
                            @if($picd->photo_edited == null)
                                <td>
                                    <img src='{{ url("storage/" . $picd->meeting_id . "/" . $picd->photo) }}'
                                    class="img-fluid img-thumbnail" alt={{ $picd->photo }}>
                                </td>
                            @else
                                <td>
                                    <img src='{{ url("storage/" . $picd->meeting_id . "/" . $picd->photo_edited) }}' 
                                    class="img-fluid img-thumbnail" alt={{ $picd->photo }}>
                                </td>
                            @endif
                            <td>{{ $picd->remarks }}</td>                          
